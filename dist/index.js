...
var shouldUpdate = function (el, binding, vnode, oldVnode) {
    ...
    var diff = index$1(vnode.children, oldVnode.children);
...
function installVFlowGrid(Vue, options) {
    var checkUpdate = function (el, binding, vnode, oldVnode) {
...
function reflow(el, binding, vnode, oldVnode) {
    ...
    columns.forEach(function (c) { return el.appendChild(c); });
